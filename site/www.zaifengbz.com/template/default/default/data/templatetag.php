<?php return array (
  ...
  array (
    'id' => 13,
    'name' => '列表页左侧联系我们调用',
    'tagcontent' => '<div class="box1"> <div class="title"> <div class="lanwd">{lang(contactus)}</div> <div class="english">/ CONTACT US</div> </div> <div class="content"> <div class="p1g"> <ul class="ul2g"> <li>{lang(address)}：{get(address)}</li> <li>{lang(tel)}：{get(tel)}</li> <li>{lang(fax)}：{get(fax)}</li> <li>{lang(email)}：{get(email)}</li> </ul></div> <form name="listform" id="listform" action="＜?php echo url(\'archive/email\');?＞" method="post"> <input type="text" name="email" class="mail" value=""> <input type="submit" value=" " name="submit" class="mailbtn" /> </form> <div class="blank10"></div> <div class="blank10"></div> </div> </div>',
    'tagfrom' => 'define',
    'setting' => 
    array (
      'onlymodify' => '',
