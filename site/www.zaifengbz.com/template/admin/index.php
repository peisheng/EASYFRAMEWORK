...
<title><?php echo get('sitename');?> - 后台管理中心 - Powered by 誉百度工作室</title>
<!-- 调用样式表 -->
<link href="{$skin_path}/admin.css" rel="stylesheet" type="text/css" />
<link title="skin1" href="{$skin_path}/admin_style_a.css" type="text/css" rel="alternate stylesheet" disabled />
<link title="skin2" href="{$skin_path}/admin_style_b.css" type="text/css" rel="stylesheet"/>
<link title="skin3" href="{$skin_path}/admin_style_c.css" type="text/css" rel="stylesheet"/>
<link title="skin4" href="{$skin_path}/admin_style_d.css" type="text/css" rel="stylesheet"/>
<link title="skin5" href="{$skin_path}/admin_style_e.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" language="javascript" src="{$skin_path}/js/styleswitcher.js"></script>
...
<!-- 头部 -->
<div class="icons">
<a onclick="setActiveStyleSheet('skin1'); return false;" href="#"><img src="{$skin_path}/images/bg_2.gif" /></a>
<a onclick="setActiveStyleSheet('skin2'); return false;" href="#"><img src="{$skin_path}/images/bg_1.gif" /></a>
<a onclick="setActiveStyleSheet('skin3'); return false;" href="#"><img src="{$skin_path}/images/bg_3.gif" /></a>
<a onclick="setActiveStyleSheet('skin4'); return false;" href="#"><img src="{$skin_path}/images/bg_4.gif" /></a>
<a onclick="setActiveStyleSheet('skin5'); return false;" href="#"><img src="{$skin_path}/images/bg_5.gif" /></a>
</div> 
...
<dd class="m{=$j++} {$class1}"><a href="{$m}" {if $n=='CNZZ站长统计' || $n=='网站安全检查'}target="_blank"{/if}><span class="d{=$k++}">{$n}</span></a></dd>
{/loop}
<?php $i++;?>
<?php $j++;?>
<?php $k++;?>
