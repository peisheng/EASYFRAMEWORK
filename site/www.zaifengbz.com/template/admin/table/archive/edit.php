...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="table2">
    ...
    <tr>
        ...
        <td width="1%">&nbsp;</td>
        <td width="70%">{form::getform('htmlrule',$form,$field,$data)}
...
<img src="{$skin_path}/images/remind.gif" alt="" width="14" height="20"  style="margin-left:10px; margin-right:5px;">
            ...
            <span style="float:left;">保存地址：<span id="attachment_path">{=archive_attachment(@$data['aid'],'path')}</span></span><input style="float:left;" type="button" name="delbutton"  class="a_del" onclick="attachment_delect(get('attachment_id').value)" />
<div class="blank10"></div>
