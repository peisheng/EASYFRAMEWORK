...
<div id="nav">
<p><span style="float:right">    </span>您好，<strong>{$user.username}！</strong> [<a href="{$base_url}/index.php?case=index&act=logout&admin_dir={config::get('admin_dir')}">退出</a>]
...
<!-- 页底 -->
<div id="footer">
&copy&nbsp;{get(sitename)}&nbsp;<a href="http://www.cmseasy.cn" title="Powered by 誉百度工作室" target="_blank">Powered by 誉百度工作室</a>
</div>
</body>
</html>