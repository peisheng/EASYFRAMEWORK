...
<meta name="Copyright" content="2009-2011 CmsEasy Inc" />
<meta name="description" content="" />
<meta content="" name="keywords" />
<link rel="icon" href="<?php echo $base_url;?>/favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="<?php echo $base_url;?>/favicon.ico" type="image/x-icon" />
<title><?php echo get('sitename');?> - 后台管理中心 - Powered by 誉百度工作室 - Powered by CmsEasy</title>
<!-- 调用样式表 -->
<link href="<?php echo $skin_path;?>/admin.css" rel="stylesheet" type="text/css" />
<link title="skin1" href="<?php echo $skin_path;?>/admin_style_a.css" type="text/css" rel="alternate stylesheet" disabled />
<link title="skin2" href="<?php echo $skin_path;?>/admin_style_b.css" type="text/css" rel="stylesheet"/>
<link title="skin3" href="<?php echo $skin_path;?>/admin_style_c.css" type="text/css" rel="stylesheet"/>
<link title="skin4" href="<?php echo $skin_path;?>/admin_style_d.css" type="text/css" rel="stylesheet"/>
<link title="skin5" href="<?php echo $skin_path;?>/admin_style_e.css" type="text/css" rel="stylesheet"/>
<script type="text/javascript" language="javascript" src="<?php echo $skin_path;?>/js/styleswitcher.js"></script>
...
<![endif]--> 
<a href="http://www.cmseasy.cn" title="Powered by CmsEasy" target="_blank">Powered by CmsEasy</a>
<body class="slide slide3 s1">
<!-- 头部 -->
<div class="icons">
<a onclick="setActiveStyleSheet('skin1'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_2.gif" /></a>
<a onclick="setActiveStyleSheet('skin2'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_1.gif" /></a>
<a onclick="setActiveStyleSheet('skin3'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_3.gif" /></a>
<a onclick="setActiveStyleSheet('skin4'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_4.gif" /></a>
<a onclick="setActiveStyleSheet('skin5'); return false;" href="#"><img src="<?php echo $skin_path;?>/images/bg_5.gif" /></a>
</div> 
...
if($n == '网站安全检查' && !chkpower('func_data_safe')){
continue;	
}
...
<dd class="m<?php echo $j++;?> <?php echo $class1;?>"><a href="<?php echo $m;?>" <?php if($n=='CNZZ站长统计' || $n=='网站安全检查') { ?>target="_blank"<?php } ?>><span class="d<?php echo $k++;?>"><?php echo $n;?></span></a></dd>
<?php } ?>
<?php $i++;?>
<?php $j++;?>
<?php $k++;?>
...
<div class="quick">
<!-- <a href="javascript:managemap();">网站地图</a> -->
...
<div class="copy">
Copyright © 2011 <?php echo get('sitename');?><div class="copyright"><a href="http://www.cmseasy.cn" title="Powered by 誉百度工作室" target="_blank">Powered by 誉百度工作室</a></div>
</div>

<?php if(hasflash()) { ?>
<div id='message'><?php echo showflash(); ?>
<a href="#" onclick="javascript:turnoff('message')">&nbsp;(×)</a> 
</div><?php } ?>
