<?php /* Smarty version 2.6.25, created on 2012-06-30 11:09:08
...
<p><span><?php echo $this->_tpl_vars['lang']['collect_tips']; ?>
</span></p>
<p>
...
">
  <table cellspacing="0" cellpadding="2" align="center">
    <tr>
      <td><label for="name"><span class="required"><?php echo $this->_tpl_vars['lang']['you_name']; ?>
</span></label></td>
      <td><input id="name" name="name" class="required" type="text" value="" />
			   <label for="name" class="error"><?php echo $this->_tpl_vars['lang']['please_input_you_name']; ?>
</label></td>			   
    </tr>
    <tr >
      <td><label for="email"><span class="required"><?php echo $this->_tpl_vars['lang']['email']; ?>
</span></label></td>
      <td><input id="email" name="email" class="text required email" type="text" />
			   <label for="email" class="error"><?php echo $this->_tpl_vars['lang']['please_input_you_email']; ?>
</label></td>
    </tr>
    <tr>
      <td><label for="phone"><span class="required"><?php echo $this->_tpl_vars['lang']['c_tel']; ?>
</span></label></td>
      <td><input id="phone" name="phone" class="required" type="text" value="" />
			   <label for="phone" class="error"><?php echo $this->_tpl_vars['lang']['please_input_you_tel']; ?>
</label></td>
    </tr>
  </table>
<div align="right" style="margin-right:55px;">
<input type="submit" name="button" value="<?php echo $this->_tpl_vars['lang']['submit']; ?>
" onClick="$('#customer_info').submit();" />
</div>
</form>
</p>
</div>
