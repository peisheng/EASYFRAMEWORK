...
<body class="bodyflow">
<span onclick="$('#single').css('display','block');$('#muti').css('display','none');"" style="cursor:pointer;">单文件上传</span> <span onclick="$('#single').css('display','none');$('#muti').css('display','block');" style="cursor:pointer;">多文件上传</span>
...
<!-- <a href="http://www.cmseasy.cn" title="Powered by 誉百度工作室" target="_blank">Powered by 誉百度工作室</a> -->
</body>
</html>