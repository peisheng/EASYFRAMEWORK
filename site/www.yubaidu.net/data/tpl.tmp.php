...
<link rel="icon" href="{get(site_url)}favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="{get(site_url)}favicon.ico" type="image/x-icon" />
...
<script type="text/javascript" src="{get(site_url)}js/jquery.min.js"></script>
...
<a href="{$site_url}" onclick="window.external.addFavorite(this.href,this.title);return false;" title='{get(sitename)}' rel="sidebar">{lang(favorite)} - </a>
		...
		<div id="logo"><a href="{get(site_url)}" title="{get(sitename)}"><img src="{get(site_url)}{get(site_logo)}" width="{get(logo_width)}" alt="{get(sitename)}" /></a></div>
		</div>

<div id="i_banner"><img src="{$skin_path}/banner_i.jpg" /></div>
<div id="i_menu">
<a title="{lang(homepage)}" href="{get(site_url)}" class="home">{lang(homepage)}</a>
                ...
                <div id=demo1 style="FLOAT:left">
                 <div id=demo1 style="FLOAT:left">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
                      {loop archive(3,0,0,'0,0,0',20,'aid',10,true,0) $i $archive} <td class="GalleryPictureScrollerImageArea"><div class="GalleryPictureScrollerImage"><a href="{$archive[url]}" title="{$archive[title]}"><img src="{get(site_url)}{$archive[thumb]}" alt="{$archive[title]}" /></a></div>
...
Copyright © 2010 <a href="{get(site_url)}">{get(sitename)}</a>. All Rights Reserved.
