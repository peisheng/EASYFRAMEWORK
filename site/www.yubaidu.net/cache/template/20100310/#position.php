...
<div id="bd_right_n">
<div class="bd_right_n_1">
<div class="bd_right_n_1_t"><?php echo lang(nowposition);?></div>
<div class="bd_right_n_1_tm"><a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a>
&gt;
<?php
