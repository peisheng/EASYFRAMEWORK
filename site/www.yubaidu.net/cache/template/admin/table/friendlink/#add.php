...
<td width="1%">&nbsp;</td>
<td width="70%">
<?php echo form::getform('linktype',$form,$field,$data);?>
</td>
</tr>
...
<td width="1%">&nbsp;</td>
<td width="70%">
<?php echo form::getform('listorder',$form,$field,$data);?>
</td>
</tr>
...
<td width="1%">&nbsp;</td>
<td width="70%">
<?php echo form::getform('url',$form,$field,$data);?>
</td>
</tr>
...
<td width="1%">&nbsp;</td>
<td width="70%">
<?php echo form::getform('logo',$form,$field,$data);?>
</td>
</tr>
...
<td width="1%">&nbsp;</td>
<td width="70%">
<?php echo form::getform('state',$form,$field,$data);?>
</td>
</tr>
