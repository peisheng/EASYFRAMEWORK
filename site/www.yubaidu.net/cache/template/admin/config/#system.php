...
使用说明：<br />
1、首先，点击	<a href="http://dev.baidu.com/wiki/static/map/API/tool/getPoint/" style="height:22px;line-height:22px;background:#2D9607;font-weight:bold;color:white;border:1px solid #ccc;" target="_blank">&nbsp;按钮&nbsp;</a>	，获取地图数值；<br />
