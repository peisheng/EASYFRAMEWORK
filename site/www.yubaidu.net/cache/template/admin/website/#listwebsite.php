...
<a href="index.php?case=website&act=addwebsite&admin_dir=<?php echo get('admin_dir');?>&site=default"  class="btn_c">增加站点</a>
...
<td align="left" style="padding-left:10px;"><?php echo $d['name'];?></td>
<td align="left" style="padding-left:10px;"><?php echo $d['url'];?></td>

<td align="center">
<span class="hotspot" onmouseover="tooltip.show('切换管理网站内容');" onmouseout="tooltip.hide();"><a href="<?php echo $d['url'];?>index.php?case=admin&act=remotelogin&admin_dir=<?php echo $d['admindir'];?>&args=<?php echo $d['args'];?>&submit=1" target="_blank" class="a_management"></a></span>
