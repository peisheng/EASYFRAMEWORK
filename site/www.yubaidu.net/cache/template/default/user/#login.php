...
<?php if($ologinlist) { ?>
<?php foreach($ologinlist as $ologin) { ?>
        											<?php if($ologin['enabled']==1) { ?> 
       													<a target="_blank" href="<?php echo url('user/ologin/logtype/'.$ologin['ologin_code']);?>"><img src="images/<?php echo $ologin['ologin_code'];?>.png" border="0" /></a>&nbsp;&nbsp;
        											<?php } ?>
        										<?php } ?>
        								<?php } ?> 
</td>
