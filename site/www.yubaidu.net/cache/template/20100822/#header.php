...
<div id="main">
  <div id="header">
  	<div class="top">
        ...
        <div class="top_right">
        	<div class="top_links">
<a href="<?php echo $site_url;?>"><?php echo lang(homepage);?></a><a href="<?php echo $site_url;?>" onclick="window.external.addFavorite(this.href,this.title);return false;" title='<?php echo get(sitename);?>' rel="sidebar"><?php echo lang(favorite);?></a><a title="留言" href="<?php echo url('guestbook');?>" target="_blank"><?php echo lang(feedback);?></a><a id="StranLink" title="繁简转换">繁体</a>
        	</div>
            <div class="rexian"><?php echo get(tel);?></div>
        </div>
    </div>
