...
<div class="titleg"><div class="title_wd"><?php echo lang(nowposition);?></div><div class="moreg"><a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a>
&gt;
<?php
