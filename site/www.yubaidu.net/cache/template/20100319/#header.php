...
<div id="main">
<div id="header">
    	<div id="header_logo"><a href="<?php echo $base_url;?>/"><img src="<?php echo $base_url;?>/<?php echo get('site_logo');?>" alt="<?php echo $sitename;?>" width="<?php echo get('logo_width');?>"></a></div>
        <div id="header_top">
       	  <ul class="topul_ul">
<li><a href="<?php echo $site_url;?>" onclick="window.external.addFavorite(this.href,this.title);return false;" title='<?php echo get(sitename);?>' rel="sidebar"><?php echo lang(favorite);?></a></li>
<li><a title="<?php echo lang(feedback);?>" href="<?php echo url('guestbook');?>" target="_blank"><?php echo lang(feedback);?></a></li>
<li><a id="StranLink" title="繁简转换">繁体</a></li>
          </ul>
        </div>
        <div id="header_nav">
        	<div class="header_navl"><img src="<?php echo $skin_path;?>/tz_5.gif" /></div>
            <ul class="nav_ul">
<li><a title="<?php echo lang(backhome);?>" href="<?php echo $base_url;?>/" class="home"><?php echo lang(homepage);?></a></li>
...
<?php } ?>
        ...
        <div id="header_banner"><img src="<?php echo $skin_path;?>/tz_1.jpg" /></div>
</div>