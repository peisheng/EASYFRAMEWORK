...
case 1:
var files='<?php echo $base_url;?>/<?php echo get(slide_pic1);?>';/*广告图片*/
    var links='<?php echo get(slide_pic1_url);?>';/*图片上的链接,注意链接中的&要用%26替换*/
    var texts='<?php echo get(slide_pic1_title);?>';/*图片标题*/
break
case 2:
var files='<?php echo $base_url;?>/<?php echo get(slide_pic1);?>|<?php echo $base_url;?>/<?php echo get(slide_pic2);?>';/*广告图片*/
...
break
case 3:
var files='<?php echo $base_url;?>/<?php echo get(slide_pic1);?>|<?php echo $base_url;?>/<?php echo get(slide_pic2);?>|<?php echo $base_url;?>/<?php echo get(slide_pic3);?>';/*广告图片*/
...
break
    case 4:
var files='<?php echo $base_url;?>/<?php echo get(slide_pic1);?>|<?php echo $base_url;?>/<?php echo get(slide_pic2);?>|<?php echo $base_url;?>/<?php echo get(slide_pic3);?>|<?php echo $base_url;?>/<?php echo get(slide_pic4);?>';/*广告图片*/
...
break
   default:
   var files='<?php echo $base_url;?>/<?php echo get(slide_pic1);?>|<?php echo $base_url;?>/<?php echo get(slide_pic2);?>|<?php echo $base_url;?>/<?php echo get(slide_pic3);?>|<?php echo $base_url;?>/<?php echo get(slide_pic4);?>|<?php echo $base_url;?>/<?php echo get(slide_pic5);?>';/*广告图片*/
