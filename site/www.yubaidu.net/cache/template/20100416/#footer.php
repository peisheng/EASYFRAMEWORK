<?php defined('ROOT') or exit('Can\'t Access !'); ?>
    <div id="footer">
        <div class="footer_nav"><div class="footer_l"><img src="<?php echo $skin_path;?>/jt_27.gif" /></div>
        <div class="baiwd12">
...
<?php?>
       ...
       <div class="nav_yyg"><?php echo get(site_right);?> <a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a> All Rights Reserved.      
<div class="blank5"></div>
<?php echo getcnzzcount();?>&nbsp;&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo get('site_icp');?></a></span></div>
<!-- 非商业用户请勿删除 -->
