...
<div class="bd_left_titlegg">
<div class="titlegg"><?php echo $category[$catid]['catname'];?></div>
<div class="more1"><a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a>
&gt;
<?php
