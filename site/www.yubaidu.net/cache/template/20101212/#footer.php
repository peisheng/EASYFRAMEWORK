...
<a href="#">TOP</a></div>
        ...
        <div class="bottom_cprt"><?php echo get(site_right);?> <a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a> All Rights Reserved. </div>
    </div><!--fooder部结束-->
</div>
<!-- 非商业用户请勿删除 -->
<div class="copyright">
&nbsp;&nbsp;<?php echo getcnzzcount();?>&nbsp;&nbsp;<a href="http://www.miibeian.gov.cn/" target="_blank"><?php echo get('site_icp');?></a></div></div>
...
<script type="text/javascript" src="<?php echo $base_url;?>/js/tc.js"></script>
