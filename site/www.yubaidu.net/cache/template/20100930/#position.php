...
<div class="title1g">
            	<div class="title1g_left"><img src="<?php echo $skin_path;?>/xx_25g.gif" /></div>
                <div class="title1g_ioc"><img src="<?php echo $skin_path;?>/xx_27g.gif" /></div>
              <div class="title1g_wd"><?php echo lang(nowposition);?></div>
                <div class="moreg"><a title="<?php echo get('sitename');?>" href="<?php echo $base_url;?>/"><?php echo get('sitename');?></a>
&gt;
<?php
