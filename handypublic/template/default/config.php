<?php
//本页面为模版结构参数配置，非开发人员请勿改动，会导致模版出错。开发人员可以看注释自行修改。
//模板说明

$temptitle = "淘客帝国6.0官方模版";  //模版的标题

$tempabout = "淘客帝国6.0官方模版，拥有所有程序已经支持的功能，随程序版本更新。"; //模版的简介
...
13=>"瀑布流首页模块类型",
21=>"淘宝推广频道",
1=>"淘宝店铺(淘宝API)",				对应文件 index_mode1.php
2=>"淘宝限时打折(淘宝API)",
3=>"淘宝普通推广(淘宝API)",
4=>"分享发布商品",
7=>"(分享)仅后台导入的",
...
$CustomVariable["CustomField"][12] = array("pronum"=>"推荐商品数");
...
//自定义的列表
$CustomVariable["AllowIndexTypeArr"][12] = 	array("title"=>"编辑推荐商品","typelevel"=>1,"is_pic"=>0,"max_num"=>1,"allow_tid"=>"2,3,4,5,7,10,15"); 
//文章模块类别设置
...
//设定配置中心设置的导航类型。
$CustomVariable["CustomDaohang"]["daohang"] = 	array("title"=>"主导航设置","typelevel"=>2,"is_pic"=>0);  //主导航参数
$CustomVariable["CustomDaohang"]["daohang"]["CustomSetField"]["ishot"] = array("memo"=>"是否热门标签","default"=>"2","list"=>array("1"=>"是","2"=>"否")); 

$CustomVariable["CustomDaohang"]["cidaohang"] = array("title"=>"二级导航","typelevel"=>2,"is_pic"=>0);  //次导航
...
$CustomVariable["CustomSetField"]["SetLogin"] = array("memo"=>"自定义登陆框位置代码","default"=>"","list"=>"textarea");  //公告。
$CustomVariable["CustomSetField"]["showhelp"] = 			array("memo"=>"底部帮助模块显示","default"=>"1","list"=>array("1"=>"显示","2"=>"隐藏"));  //列表页类型
$CustomVariable["CustomSetField"]["showuser"] = 			array("memo"=>"用户登陆框是否显示","default"=>"1","list"=>array("1"=>"显示","2"=>"隐藏"));  //列表页类型
$CustomVariable["CustomSetField"]["ProlistType"] = 			array("memo"=>"列表页默认类型，可选横向和竖向","default"=>"1","list"=>array("1"=>"横向","2"=>"竖向"));  //列表页类型
...
$CustomVariable["CustomSetField"]["ProListArtNum"] = 		array("memo"=>"左侧相关推荐文章数量","default"=>"10","list"=>"no");  //列表页是否显示子排序
$CustomVariable["CustomSetField"]["ProListproNum"] = 		array("memo"=>"文章列表页面推荐商品数量","default"=>"10","list"=>"no");  //文章页面推荐商品的数量设置。
$CustomVariable["CustomSetField"]["ProArticleproNum"] = 	array("memo"=>"文章详情页面推荐商品数量","default"=>"8","list"=>"no");  //文章页面推荐商品的数量设置。
$CustomVariable["CustomSetField"]["ProArticleproKeyword"] = array("memo"=>"文章详情页面默认商品搜索词","default"=>"包邮","list"=>"no");  //文章页面推荐商品的数量设置。
$CustomVariable["CustomSetField"]["ProListproKeyword"] = 	array("memo"=>"文章列表页面默认商品搜索词","default"=>"包邮","list"=>"no");  //文章页面推荐商品的数量设置。
...
$CustomAdList["dongtai"] = 		array("name"=>"会员动态下面的","height"=>"167","width"=>"234","description"=>"会员动态下面的方形位置");
$CustomAdList["typesright"] = 	array("name"=>"综合类别右侧的","height"=>"auto","width"=>"285","description"=>"在综合类别右侧，TAGS列表上面的位置。高度可以任意。");
$CustomAdList["top"] = 			array("name"=>"最顶部的广告","height"=>"auto","width"=>"auto","description"=>"最顶部的广告，不限制长宽的。");
$CustomAdList["mleft"] = 		array("name"=>"登陆和注册的左边","height"=>"auto","width"=>"399","description"=>"登陆注册页面的左侧大图片位置。");
$CustomAdList["footer"] = 		array("name"=>"最低下的一排小图片","height"=>"auto","width"=>"auto","description"=>"最底下的一排图片，要修改在这个广告位改。");
$CustomAdList["typestop"] = 	array("name"=>"综合分类上方","height"=>"auto","width"=>"980","description"=>"综合分类模块的上面通栏。");

$CustomAdList["paileft"] = 	array("name"=>"拍拍列表页左侧下方","height"=>"auto","width"=>"230","description"=>"拍拍列表页面左边分类下面的位置，高度不限制。");
