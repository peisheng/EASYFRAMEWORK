...
function resizeimg(ImgD,iwidth,iheight) { 
	...
	if(image.width>0 && image.height>0){ 
		   ...
		   if(ImgD.parentNode!=null){
			   if(ImgD.parentNode.tagName=="TD"){
				    ImgD.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow ='hidden';
			   }else if(ImgD.parentNode.parentNode.tagName=="TD"&&ImgD.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.tagName=="DIV"){
				    ImgD.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow ='hidden';
			   }else if(ImgD.parentNode.tagName=="DIV"){
