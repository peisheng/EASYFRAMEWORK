...
/*首页论坛列表*/
.news {width: 305px;margin: 5px 5px 0 0;padding: 0 0 10px;float: left;}
...
.news ul{width:303px;border:1px solid #e6c5c5; border-top:none; padding-top:10px;background: url(<?php echo $rootroad;?>/img/newsindex_bg.jpg) repeat-x top;}
.news ul li{background: url(<?php echo $rootroad;?>/img/news-item-icon.gif) no-repeat 5px 5px;padding: 0 0 0 15px;width:288px;height:22px;_height:20px; text-align:left; overflow:hidden;white-space:nowrap;}
.news ul li a{color:#4a4a4a;display: block;float: left;width:220px;overflow:hidden;}
