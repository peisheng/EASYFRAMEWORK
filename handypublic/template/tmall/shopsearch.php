...
<div class="listweizhi">您的位置:<a href="<?php echo $rootroad;?>/">首页</a>><a href="<?php echo $listurl ?>"><?php echo $cat_name ?></a></div>
<div class="shuliang">在<span>淘宝网</span>搜索到商铺<span><?php echo $totalResults ?></span>家。</div>
</div>
