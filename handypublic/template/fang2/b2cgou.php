...
<li><div class="img"><a href="$v[url]"  $v[rel] target="$v[target]">
          ...
          <div class="info"><div class="lef"><p>优惠价：<b><?php echo $v["price"] ?></b></p><p>市场价：<?php echo ($v["price"]*$CustomSetFieldValue[ProShiChang]); //调用市场价格?>元</p><p>来源：<a  href="$v[shop_click_url_base64]" rel='nofollow' target="_blank"><?php echo $v["seller_name"] ?></a></p></div>
