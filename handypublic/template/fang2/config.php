...
$CustomVariable["AllowIndexType"]="2,3,5,6,7,10,11,15,13,21"; 
...
$CustomVariable["AllowIndexTypeArr"][11]["tuijian"] = 	array("title"=>"推荐类别","typelevel"=>1,"is_pic"=>0,"max_num"=>4);  
...
$CustomVariable["CustomSetField"]["ProListKeywordNum"] = array("memo"=>"商品列表页推荐商品数量","default"=>"15","list"=>"no");  //文章页面推荐商品的数量设置。
