...
<div class="list_left">
<div class="list_dh">
<div class="titt"> 您的位置： <a href="<?php echo $rootroad;?>/" class="hom">首页</a> &#8250; 网站地图
	</div>
<?php
...
<table class="money">
<tr>
<th rowspan="3" style="width:100px;"><a class='ts0' href="<?php echo $big["url"];?>" target="_blank"><?php echo $bigname ?></a></th>
<td>
