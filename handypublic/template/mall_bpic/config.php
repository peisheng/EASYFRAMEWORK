...
$tempabout = "新淘宝商城模板，大气漂亮。在模板基础上加大首页图片尺寸。";
...
$CustomVariable["CustomField"][12] = array("leftnum"=>"左侧商品数量","rightnum"=>"右侧商品数量");
$CustomVariable["CustomField"][21] = array("height"=>"高度(像素)","hidentop"=>"隐藏(像素)");

$CustomVariable["AllowIndexTitle"][11] = "首页焦点切换图";
...
//自定义的列表
$CustomVariable["AllowIndexTypeArr"][12]["left"] = 	array("title"=>"左侧推荐商品","typelevel"=>1,"is_pic"=>0,"max_num"=>1,"allow_tid"=>"5,10,15"); 
$CustomVariable["AllowIndexTypeArr"][12]["right"] = array("title"=>"右侧推荐商品","typelevel"=>1,"is_pic"=>0,"max_num"=>1,"allow_tid"=>"5,10,15"); 
$CustomVariable["AllowIndexTypeArr"][12]["base"] = 	array("title"=>"综合分类","typelevel"=>2,"is_pic"=>0); 
$CustomVariable["AllowIndexTypeArr"][11] = 	array("title"=>"编辑左侧商品分类","typelevel"=>2,"is_pic"=>0); 
//文章模块类别设置
...
$CustomVariable["CustomDaohang"]["cidaohang"] = array("title"=>"栏目二级导航","typelevel"=>2,"is_pic"=>0,"max_num"=>5);  //次导航
...
$CustomVariable["CustomSetField"]["GongGao"] = array("memo"=>"首页公告","default"=>"欢迎来到本站购物，本站所有商品折扣优惠酬宾！","list"=>"textarea");  //公告。
$CustomVariable["CustomSetField"]["IndesShowChongzhi"] = 	array("memo"=>"首页充值框","default"=>"open","list"=>array("open"=>"显示","close"=>"不显示"));  //列表页是否显示子类别
...
$CustomAdList["tonglan_mall"] = 		array("name"=>"通栏广告","height"=>"auto","width"=>"1004","description"=>"所有页面的导航下面用。包括首页。长宽不限");
...
$CustomAdList["tuijiandown"] = 	array("name"=>"推荐品牌下面的","height"=>"auto","width"=>"590","description"=>"推荐品牌的下面广告位，可以用来补充推荐品牌和左右两侧商品的高度差别。");
$CustomAdList["gonggaodown"] = 	array("name"=>"首页公告的下面","height"=>"90","width"=>"189","description"=>"公告下方的小图片。");

$CustomAdList["leftbanner"] = 	array("name"=>"logo右侧位置","height"=>"54","width"=>"700","description"=>"logo右侧广告。");
