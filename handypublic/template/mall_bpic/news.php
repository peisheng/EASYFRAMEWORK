...
/*首页论坛列表*/
.news {width: 326px;margin: 5px 5px 0 0;padding: 0 0 10px;float: left;}
...
.news ul{width:324px;border:1px solid #e6c5c5; border-top:none; padding-top:10px;background: url(<?php echo $rootroad;?>/img/newsindex_bg.jpg) repeat-x top;}
.news ul li{background: url(<?php echo $rootroad;?>/img/news-item-icon.gif) no-repeat 5px 8px;padding: 0 0 0 15px;width:308px;height:22px;_height:20px; text-align:left; line-height:25px; overflow:hidden;}
.news ul li a{color:#4a4a4a;display: block;float: left;width:250px;overflow:hidden;}
...
<div class="news">              
<div class="news-title"><span><?php echo $list["typename"];?></span><span class="more"><a href="<?php echo $list["typedir"];?>" target="_blank">更多&raquo;</a></span></div>
<ul>
	<?php 
	$listnews = $list["artlist"];
