...
.news ul li{background: url(<?php echo $rootroad;?>/img/news-item-icon.gif) no-repeat 5px 8px;padding: 0 0 0 15px;width:288px;height:22px;_height:20px; text-align:left; overflow:hidden;white-space:nowrap; line-height:20px;}
.news ul li a{color:#4a4a4a;display: block;float: left;width:230px;overflow:hidden;}
