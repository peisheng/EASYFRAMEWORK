...
class items_tagsAction extends baseAction
{
    ...
    function index()
    {
        ...
        $big_menu = array('javascript:art.dialog({id:\'add\',iframe:\'?m=items_tags&a=add\', title:\'添加标签\', width:\'500\', height:\'300\', lock:true}, function(){var d = art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){art.dialog({id:\'add\'}).close()});void(0);', '添加标签');
        $page = $p->show();
