...
class items_cateAction extends baseAction
{
    ...
    function index()
    {
        ...
        $big_menu = array('javascript:art.dialog({id:\'add\',iframe:\'?m=items_cate&a=add\', title:\'添加类别\', width:\'690\', height:\'400\', lock:true}, function(){var d = art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){art.dialog({id:\'add\'}).close()});void(0);', '添加标签');
