...
class items_collectAction extends baseAction
{
    public function index()
    {
        ...
        $big_menu = array('javascript:art.dialog({id:\'add\',iframe:\'?m=items_collect&a=add\', title:\'添加来源\', width:\'500\', height:\'250\', lock:true}, function(){var d = art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){art.dialog({id:\'add\'}).close()});void(0);', '添加来源');
    ...
    private function _upload($file)
    {
        ...
        $upload->savePath = WEBROOT.'uploadfile/author/';
        $upload->thumb = true;
