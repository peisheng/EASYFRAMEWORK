...
namespace Web.Areas.Admin.Controllers
{
    public class SysEnterpriseController : Controller
    {
        ...
        {
            var model = _sysEnterpriseService.GetAllEnt().Select(a => new { a.EnterpriseName, User = a.SysUser.Count(), a.MaxUser,a.Host, a.Validity, a.Enabled, a.CreatedDate, a.Remark, a.Id });
